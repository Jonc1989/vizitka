	...
	<div class="container">
		...
		<div class="footer-container">
			...
			<div class="center soc-icons">
				<a target="_blank" href="<?php echo get_option( 'telegram_input' ); ?>">
					...
					<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						...
						<g>
							...
							C-222.3,407.4-233.5,396.2-247.2,396.2z M-234.7,410.1l-5,23.9c-0.1,0.6-0.8,0.8-1.2,0.5l-6.8-4.9c-0.4-0.3-1-0.3-1.4,0l-3.8,3.1
							c-0.4,0.4-1.1,0.2-1.3-0.4l-2.6-8.4l-6.7-2.5c-0.7-0.3-0.7-1.2,0-1.5l27.7-10.7C-235.2,409-234.6,409.5-234.7,410.1z"/>
							<path class="st0" d="M-241.3,414.4l-13.2,8.1c-0.5,0.3-0.7,0.9-0.6,1.5l1.4,5c0.1,0.4,0.6,0.3,0.7,0l0.4-2.7c0.1-0.5,0.3-1,0.7-1.4
							l10.9-10.1C-240.9,414.6-241.1,414.3-241.3,414.4z"/>
						</g>
					</svg>
